...
void end_level_3(s_game_t **game, sfVector2f curs_pos)
{
...
void level_3(s_game_t **game, sfVector2f curs_pos)
{
    ...
    sfVector2f carrot_pos = {813, 743};
    sfVector2f snowball1_pos = {390, 451};
    sfVector2f snowball2_pos = {811, 364};
    ...
    if ((*game)->event.type == sfEvtMouseButtonPressed) {
        if (curs_pos.x <= (carrot_pos.x + 25) && curs_pos.x >= (carrot_pos.x)) {
            if (curs_pos.y <= (carrot_pos.y + 25) && curs_pos.y >= carrot_pos.y) {
                (*game)->obj_level3[0] = 1;
            }
        }
        if (curs_pos.x <= (snowball1_pos.x + 25) && curs_pos.x >= (snowball1_pos.x)) {
            if (curs_pos.y <= (snowball1_pos.y + 25) && curs_pos.y >= snowball1_pos.y) {
                (*game)->obj_level3[1] = 1;
            }
        }
        if (curs_pos.x <= (snowball2_pos.x + 25) && curs_pos.x >= (snowball2_pos.x)) {
            if (curs_pos.y <= (snowball2_pos.y + 25) && curs_pos.y >= snowball2_pos.y) {
                (*game)->obj_level3[2] = 1;
            }
        }
    }
    if ((*game)->obj_level3[0] == 1) {
    ...
    if ((*game)->obj_level3[2] == 1 && (*game)->obj_level3[1] == 1 && (*game)->obj_level3[0] == 1) {
        end_level_3(game, curs_pos);
    }
}